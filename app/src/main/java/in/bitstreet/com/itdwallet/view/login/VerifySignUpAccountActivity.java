...
public class VerifySignUpAccountActivity extends AppCompatActivity implements View.OnFocusChangeListener, View.OnKeyListener, TextWatcher {
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mPinHiddenEditText.getText().toString().length() == 4) {
                    ...
                    Toast.makeText(VerifySignUpAccountActivity.this, Constants.verifyToast, Toast.LENGTH_SHORT).show();
                }
    ...
    public void getOtpVerification() {
        try {
            String url = Constants.BASE_URL + "api/v1/wallet/user/verifyaccount/" + otpStr;
            String signature = SignatureGenerator.generateSignature(Constants.API_TEXT_SIGNUP_VERYFY_EMAIL + prefManager.getPublicKey(), prefManager.getPrivateKey());
            JsonObject params = new JsonObject();
            params.addProperty("email", prefManager.getEmail());
            params.addProperty("signup_mode", "mobile");
            params.addProperty("signature", signature);
            params.addProperty("publicKey", prefManager.getPublicKey());
            PostInterface apiService = ApiClient.getClient(this).create(PostInterface.class);
            Call call = apiService.getSignUpUserVerification(url, params);
            prefManager.showDialog(ctx,Constants.DIALOG_LOADING);
            prefManager.showDialog(ctx,Constants.DIALOG_VERYFING_OTP);
                ...
                public void onResponse(Call call, Response response) {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerifySignUpAccountActivity.this, LoginActivity.class);
    ...
    public class MainLayout extends LinearLayout {
        ...
        public MainLayout(Context context, AttributeSet attributeSet) {
            ...
            inflater.inflate(R.layout.activity_verify_account_signup, this);
        }
